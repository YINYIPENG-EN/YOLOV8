...
__version__ = '8.0.228'
from utils import is_pip_package, LOGGER, emojis, downloads, is_online, url2file, is_docker, is_colab, is_kaggle, \
    is_jupyter, is_github_action_running
...
@TryExcept()
def check_requirements(requirements=ROOT.parent / 'requirements.txt', exclude=(), install=False, cmds=''):
    """
    ...
    Example:
        ...
        ```
    """
    from utils import AUTOINSTALL, colorstr
...
def check_amp(model):
    from utils import ASSETS, colorstr
    """
...
def print_args(args: Optional[dict] = None, show_file=True, show_func=False):
    ...
    from utils import clean_url, colorstr
    def strip_auth(v):
